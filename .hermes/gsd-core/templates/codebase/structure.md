...
- Usage: Reference from command with `@/home/bboyd/src/cos-mcp/.hermes/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/bboyd/src/cos-mcp/.hermes/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/bboyd/src/cos-mcp/.hermes/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
