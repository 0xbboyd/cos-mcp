...
<template>
@/home/bboyd/src/cos-mcp/.hermes/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/bboyd/src/cos-mcp/.hermes/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/bboyd/src/cos-mcp/.hermes/gsd-core/workflows/transition.md`.
...
- Follow @/home/bboyd/src/cos-mcp/.hermes/gsd-core/workflows/diagnose-issues.md
