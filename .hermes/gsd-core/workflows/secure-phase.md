...
```
Agent(
  prompt="Read /home/bboyd/src/cos-mcp/.hermes/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/bboyd/src/cos-mcp/.hermes/gsd-core/templates/SECURITY.md`
