...
Reference full template: `/home/bboyd/src/cos-mcp/.hermes/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/bboyd/src/cos-mcp/.hermes/gsd-core/templates/state.md`.
