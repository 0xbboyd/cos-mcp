...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/bboyd/src/cos-mcp/.hermes/.gsd-surface.json`
(sibling to `/home/bboyd/src/cos-mcp/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/bboyd/src/cos-mcp/.hermes/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/bboyd/src/cos-mcp/.hermes/skills`).
...
`/home/bboyd/src/cos-mcp/.hermes/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/bboyd/src/cos-mcp/.hermes/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/bboyd/src/cos-mcp/.hermes/.gsd-surface.json`
Install profile marker: `/home/bboyd/src/cos-mcp/.hermes/.gsd-profile`
Skill dirs: `/home/bboyd/src/cos-mcp/.hermes/skills/gsd-*/`
Engine module: `/home/bboyd/src/cos-mcp/.hermes/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/bboyd/src/cos-mcp/.hermes/gsd-core/bin/lib/clusters.cjs`
</execution_context>
